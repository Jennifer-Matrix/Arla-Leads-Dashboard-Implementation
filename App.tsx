...
import bannerImage from 'figma:asset/57f055bf55819908e8e89a3472aadc9e0a005459.png';
import logoImage from 'figma:asset/1a117f9a28462d57259782ba88afdc646f5fe27e.png';
import dashboardImage from 'figma:asset/b7d227ffb2dd076027ca207c37b32fb9f0f64139.png';
import image_3d9cb9dbf890bd61ebe027f8ccfdcc61ca0c0912 from 'figma:asset/3d9cb9dbf890bd61ebe027f8ccfdcc61ca0c0912.png';
import vortexVirtualBanner from 'figma:asset/b85ba9a49b38d675df0a4aedb96bef5b54160b8d.png';
import image_141088bf6e403ed4b89ab0f5fbcdfd80ae38ad11 from 'figma:asset/141088bf6e403ed4b89ab0f5fbcdfd80ae38ad11.png';
import { 
  Phone, 
  Bell, 
  BarChart3, 
    ...
    <>
      ...
      <div className="relative px-6 py-8 mb-8">
        <div className="max-w-screen-2xl mx-auto">
          <img 
            src={image_3d9cb9dbf890bd61ebe027f8ccfdcc61ca0c0912}
            alt="Leads made easy banner"
      ...
      <div className="px-6 space-y-8 max-w-screen-2xl mx-auto">
        {/* Dashboard Metrics Section - Organized to match reference */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* News - Updated to match reference */}
          <Card className="bg-background border border-border">
            ...
            <CardContent className="space-y-4">
              {/* VortexVirtual Banner */}
              <div className="rounded-lg overflow-hidden">
                <img 
                  src={vortexVirtualBanner}
                  alt="VortexVirtual - Your partner in success"
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Change Over Time</TableHead>
                      <TableHead>Issued Premium</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
          ...
          {/* Mailing Campaign Availability Summary */}
          <Card>
            <CardHeader>
              <CardTitle>Mailing Campaign Availability Summary</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Type of Mailing Campaign</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
        ...
        {/* Transaction History and My Tasks */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead>Ordered ID</TableHead>
      ...
      <header className="bg-background border-b border-border px-6 py-4">
        <div className="flex items-center justify-between max-w-screen-2xl mx-auto">
          <div className="flex items-center space-x-8">
            <div className="flex items-center">
              <img 
                src={image_141088bf6e403ed4b89ab0f5fbcdfd80ae38ad11}
                alt="Arla Leads Logo"
